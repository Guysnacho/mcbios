...
export function YSEAward({ deadlinePassed }: FormProps) {
  const eligibility = [
    {
      icon: <GraduationCap className="w-6 h-6" />,
      title: "Students",
      description:
        "Graduate students conducting research in computational biology, bioinformatics, or health AI",
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Postdoctoral Fellows",
      description:
        "Postdocs advancing the field through innovative research and multidisciplinary approaches",
    },
  ];
  ...
  const process = [
    {
      ...
      description:
        "MCBIOS board members evaluate all applications based on research quality and innovation",
    },
    {
      step: "2",
      title: "Top 4 Selection",
      description:
        "Selected candidates are invited to present in a dedicated YSEA session",
    },
    {
      step: "3",
      title: "Oral Presentations",
      description:
        "Finalists present their research to a panel of expert judges including keynote speakers",
    },
    {
      step: "4",
      title: "Awards Ceremony",
      description:
        "Winners announced during the final luncheon with recognition and prizes",
    },
  ];
  ...
  const keyDates = [
    {
      ...
      event: "YSEA Application Deadline",
      urgent: true,
    },
    // { date: "February 15, 2026", event: "Finalist Notification", urgent: false },
    { date: "March 29, 2026", event: "Awards Ceremony", urgent: false },
  ];
      ...
      <div className="container mx-auto relative z-10 mt-10">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <Badge
              variant="secondary"
              className="bg-[var(--gold)] text-[var(--maroon)] px-4 py-1"
            >
          ...
          <p className="text-lg text-[var(--maroon)]/80 max-w-3xl mx-auto leading-relaxed mb-8">
            Recognize and celebrate exceptional young scientists making
            groundbreaking contributions to computational biology,
            bioinformatics, and healthcare AI. Showcase your innovative research
          ...
          {deadlinePassed ? (
            <div className="flex items-center justify-center space-x-2 mb-8 p-4 bg-[var(--maroon)]/10 rounded-lg border border-[var(--maroon)]/20 max-w-md mx-auto">
              ...
              <span className="font-medium text-[var(--maroon)]">
                Deadline Passed: January 30, 2026
              </span>
            </div>
          ) : (
          ...
          {deadlinePassed ? (
            <Button
              className="bg-[var(--gold)] text-[var(--maroon)] hover:bg-[var(--bronze)] px-8 py-3 text-lg font-medium opacity-60 cursor-not-allowed"
              size="lg"
            >
              Submission Closed
            </Button>
            ...
            >
              <a
                href="https://forms.gle/RMjTJuZATAyNuMyg7"
                target="_blank"
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {eligibility.map((item, index) => (
            <Card
              key={index}
              className="p-8 bg-white/95 backdrop-blur-sm border-[var(--gold)]/30 hover:shadow-xl transition-all duration-300 group hover:border-[var(--pink)]/50"
            >
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[var(--maroon)] mb-3">
                    {item.title}
                  </h3>
                  <p className="text-[var(--maroon)]/80 leading-relaxed">
                    {item.description}
                  </p>
                </div>
              </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-[var(--maroon)]/80 max-w-2xl mx-auto">
              A rigorous evaluation process ensures recognition of the most
              impactful young scientist contributions
            </p>
          </div>
            ...
            {process.map((item, index) => (
              ...
              >
                <div className="text-center space-y-4">
                  ...
                  <h4 className="font-bold text-[var(--maroon)]">
                    {item.title}
                  </h4>
          ...
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              <div className="text-center">
                ...
                <h4 className="font-bold text-[var(--maroon)] mb-2">
                  Professional Presentation
                </h4>
                <p className="text-[var(--maroon)]/70 text-sm">
                  Primary evaluation criterion focusing on presentation quality
                  and impact
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-[var(--maroon)]/70 text-sm">
                  Evaluation by MCBIOS board members and keynote speakers
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-[var(--maroon)]/70 text-sm">
                  Preference for innovative, cross-disciplinary research
                  contributions
                </p>
              </div>
            </div>
