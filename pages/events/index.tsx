        ...
        {registrationPassed ? (
          <div className="w-3/4 xl:w-1/2 mx-auto space-y-5">
            <Stack align={"center"} my={5} gap={3}>
              ...
              <Divider />
              <Text color={"gray.600"}>
                We want to thank everyone whose contributed to the conference
                via registrations, poster submissions, volunteering,
                sponsorships, and everything in between. As a reminder,
                registration fees include access to all scientific sessions,
                meals, receptions, banquet, and 1 year of MCBIOS membership.
                Membership gives you access to past conference recordings,
                upcomming elections, and more!
              </Text>
          ...
          <div className="w-3/4 xl:w-1/2 mx-auto space-y-5">
            <Stack align={"center"} my={5} gap={3}>
              ...
              <Divider />
              <Text color={"gray.600"}>
                If you haven&apos;t already and plan on attending this
                year&apos;s conference please pay your registration fees.
                Registration fees include access to all scientific sessions,
                meals, receptions, banquet, and 1 year of MCBIOS membership.
                Membership gives you access to past conference recordings,
                upcomming elections, and more!
