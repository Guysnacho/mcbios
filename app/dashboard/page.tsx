              ...
              <Flex align="center" gap="4">
                ...
                <Box>
                  ...
                  <Badge
                    ...
                    size="md"
                  >
                    MCBIOS {deriveRole(data?.user?.role)}
                  </Badge>
                </Box>
              </Flex>
            </Card.Body>
                ...
                <Card.Body>
                  <Stack gap="6">
                    ...
                    <Table.ScrollArea overflowX="auto">
                      <Table.Root striped colorPalette="green" size="sm">
                    ...
                    >
                      ...
                      fees to finish MCBIOS onboarding. Registration fees
                      include access to all scientific sessions, meals,
                      receptions, banquet, and 1 year of MCBIOS membership.
