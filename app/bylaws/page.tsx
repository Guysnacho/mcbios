...
export default function Page() {
  return (
    <>
      ...
      {/* Table of Contents */}
      <Box as="section" py="12" bg={{ base: "white", _dark: "gray.950" }}>
      ...
      <Box as="section" py="16" bg={{ base: "white", _dark: "gray.950" }} position="relative">
        ...
        >
          <Stack gap="16">
              ...
              <Stack gap="8">
                <Box>
                  ...
                  <Text color="slate.700" lineHeight="tall" mt="4">
                    The Society will especially support, encourage, and mentor
                    our Trainee Members.
                  </Text>
                </Box>
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    exemption for the Society from Federal taxation pursuant to
                    Section 501(a) of the Internal Revenue Code, as amended (the
                    &quot;IRC&quot;), and until such time, if ever, that such
                    exemption is denied or lost, the Society shall not be
                    empowered to engage directly or indirectly in any activity
                    which the Society believes would be likely to invalidate its
                    status as an organization exempt from federal taxation under
                    Section 501(a) of the IRC as an organization described in
              ...
              <Stack gap="8">
                ...
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    chooses that option (see the definition below, Section 3).
                    Applications shall follow procedures defined by the Board of
                    Directors. Professional members are eligible to advance in
                    three membership grades: Regular, Senior, and Fellow. The
                    Board of Directors shall define eligibility, nomination, and
                    evaluation criteria for each membership grade and set the
                    quota each year for the Senior and Fellow grades.
                  </Text>
                </Box>
                <Box>
                  <Heading
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    academic, industrial or government research facility is
                    eligible to apply for a Trainee Membership instead of a
                    Professional Membership. Trainee Membership shall terminate
                    at the end of the first membership year in which the Trainee
                    is no longer a Student or Postdoctoral Fellow. Trainee
                ...
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    membership rate. The membership begins on the first day of
                    the calendar year in which the payment is received and
                    cannot be applied retroactively to previous years or
            ...
            {/* Article IV */}
            <ArticleSection
              id="Article_IV_General_Meetings"
              title="Article IV. General Meetings"
            >
              <Stack gap="8">
                <Box>
                  <Heading
                ...
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    Meeting, the purpose for which the meeting is called. Notice
                    of an Annual or Special Meeting shall be distributed not
                    less than ten or more than 60 days before the date of the
                    meeting, provided that the Board may tentatively schedule
                    the date, place and time of the Annual Meeting, and provide
                    notice thereof, more than 60 days before the date of the
                    meeting.
                  </Text>
                </Box>
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    thereof, a majority of the Members entitled to vote who are
                    present may adjourn such meeting to another place, date or
                    time.
                  </Text>
                </Box>
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    Members shall vote by ballot, whether in person, via paper
                    ballot, or via electronic voting software; however, the vote
                    can be carried out by voice if requested. Each ballot shall
                    state the name of the Member voting and such other
                    information as the Society may require under the procedure
                ...
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    forth the action taken. For this, the minimum number of
                    Members needed is the same as the number that would be
                    necessary to authorize or take the action at a meeting at
                    which all Members entitled to vote were present and voted.
                    The Secretary shall give prompt notice of any corporate
                    action taken by less than unanimous consent without a
                    meeting to the Regular Members who have not consented in
                    writing.
                  </Text>
                </Box>
              </Stack>
              ...
              <Stack gap="8">
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    Special Meetings of the Society; shall be responsible for
                    executing policies determined by the Board of Directors;
                    shall act as spokesperson for the Society; and shall see
                    that all Orders and Resolutions of the Board of Directors
                    are carried into effect. The Past President and the
                    President-Elect shall assist the President, shall be members
                    of the Board of Directors, and shall substitute for the
                    President when necessary. The Past President shall take
                    precedence over the President-Elect in substituting for the
                    President. The Past-President shall prepare a slate of
                    nominees for the President position to give to the Board of
                    Directors for presentation to the membership at the Annual
                    Meeting. Immediately after the Annual Meeting, the
                    President-Elect will take the role of President while the
                    current President shall become Past President. The Past
                    President must take care of any remaining items from the
                    tenure of their term over the next 3 months, including
                    submitting the annual report for the Annual Meeting and
                ...
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    President, and the Past President are required to be Members
                    of the Society and in good standing. Election of the
                    President-Elect shall be by simple plurality of votes
                    received from all Members attending the election during the
                    Annual Meeting, either in person or through an electronic
                    voting software. The President-Elect shall assume that
                    office at the conclusion of the Annual Meeting and, at the
                    same time, the previous President-Elect shall assume the
                    office of President at the conclusion of the Annual Meeting
                    and, at the same time, the previous President shall become
                    Past President. The Past President shall not be eligible for
                    re-election to the office of President-Elect for a period of
                    one year after completing their term as Past President.
                  </Text>
                </Box>
                <Box>
                  <Heading
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    Directors and Special Meetings. The Past President shall
                    take over the role of Secretary if neither Secretary or Past
                    Secretary are present for a meeting of the Board of
                    Directors or a Special Meeting. The Secretary shall be
                    appointed by the President from the Board of Directors and
                    approved by the Board of Directors and may not also hold a
                    Presidential Office. The Secretary shall substitute for the
                    President if neither the Past President nor the
                    President-Elect can serve and, at the same time, the Past
                    Secretary will take over the Secretary position.
                  </Text>
                </Box>
                <Box>
                  <Heading
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    full, timely, and accurate accounting of receipts and
                    disbursements in books belonging to the Society. Both
                    Treasurers shall render to the President and Board of
                    Directors at its Regular Meetings, or when the Board of
                    Directors so requires, an account of the financial
                    transactions and status of the Society. The Treasurer shall
                    serve as Chairperson of the Finance Committee. The Treasurer
                    shall be appointed by the President annually and approved by
                    the Board of Directors and does not have term limits. When
                    the President appoints a new Treasurer, the current
                    Treasurer will automatically become the Backup Treasurer.
                    The Treasurer serves as a non-voting Board Member and shall
                    substitute for the President if the Past President, the
                    President-Elect, and the Secretary cannot serve. In a
                    situation in which the Treasurer resigns or is replaced by a
                    majority vote of the Board of Directors, the Backup
                    Treasurer will take his/her position as Treasurer.
                  </Text>
                </Box>
                <Box>
                  <Heading
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    of the Society. The Board may make such authorization
                    general or special.
                  </Text>
                </Box>
              </Stack>
            ...
            {/* Article VI */}
            <ArticleSection
              id="Article_VI_Board_of_Directors"
              title="Article VI. Board of Directors"
            >
              <Stack gap="8">
                <Box>
                  <Heading
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    Secretary, and other non-executive committee members. Each
                    of the Directors shall have one vote. Each director shall
                    serve 3 years per term and can be re-elected for at most one
                    additional term for a total of 6 consecutive years. Each
                    board member is required to lead in an area of
                    responsibility deemed important for the maintenance and
                    growth of the organization, including but not limited to:
                    membership development, workgroup coordination, website
                    development, public relations, nomination and election,
                    fund-raising, Annual Meeting organization, documentation,
                ...
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    the meeting to another place, date or time without further
                    notice.
                  </Text>
                </Box>
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    provide written notice to each Director of the time, place,
                    date and purpose of the meeting of not less than three
                    business days. Meetings may be conducted in person, via
                    videoconference, and/or by telephone or other form of live
                    telephonic communication. The Board of Directors may also
                    conduct business by mail, email, web surveys or other
                    written consents.
                  </Text>
                </Box>
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    Director position will be made available for a total of a
                    minimum of two but a maximum of three Director positions, in
                    addition to the President-Elect, to be elected at the Annual
                    Meeting. If an existing Board Member is elected to be a
                    Presidential Officer (e.g., President-Elect), a replacement
                    will then be elected. Newly-elected Directors are required
                    to be Members of the Society and in good standing. Board
                    Members who are completing their term on the Board may not
                    be immediately re-elected except as President-Elect but may
                    be re-elected to another term as a Board Member after one
                    year. Newly-elected Directors shall assume office at the
                ...
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    Meeting at which time the Members shall elect a replacement
                    to serve out the remaining term, if any, of that Director.
                  </Text>
                </Box>
                <Box>
                  <Heading
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    fulfill the duties of a Director. In such a situation, the
                    President (but if the President is accused, the
                    responsibility should be taken by the Past President) needs
                    to investigate and present the evidence in written form to
                    the rest of the Board of Directors (excluding the accused
                    and accuser) to solicit an anonymous vote of removal. The
                    number of votes must meet or exceed the quorum (calculated
                    based on the remaining number of Board of Directors) to
                    proceed with the removal. If the support for removal exceeds
                    a minimum of 70% of the votes, the announcement of the
                    removal will also be posted on the organization website with
                    the verbiage approved by the Board of Directors. The Board
                    of Directors shall name an acting replacement Director to
                    serve the remainder of the current term year until the next
                    Annual Meeting at which time the Members shall elect a
                ...
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    if that Director held the office of Past President, the
                    Board will function for the remainder of the term year
                    without that officer, with the Membership electing a new
                    President-Elect (as usual) at the next Annual Meeting. If
                    the resigning/removed Director held the office of President,
                    then the President-Elect will immediately become President
                    for the remainder of the current term year and will remain
                    as President for the subsequent term year, as originally
                    planned, with the Members electing a new President-Elect (as
                    usual) at the next Annual Meeting. If the resigning Director
                    held the office of President-Elect, the Board will function
                    for the remainder of the term year without that officer and
                    the Members shall elect both a President and President-Elect
                ...
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    Members for monetary damages for breach of fiduciary duty as
                    a Director.
                  </Text>
                </Box>
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    responsible. They may be held accountable for failing to
                    address the responsibilities associated with their positions
            ...
            {/* Article VII */}
            <ArticleSection
              id="Article_VII_Board_Guidelines"
              title="Article VII. The Board Guidelines"
            >
              <Stack gap="8">
                <Box>
                  <Heading
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    the Society which have been approved by Board of Directors
                    with a majority vote. These committees appointed by the
                    Board of Directors act for the Board for special purposes
                    and the individuals serving on the committees may or may not
            ...
            {/* Article VIII */}
            <ArticleSection
              id="Article_VIII_Chapters_and_Working_Groups"
              title="Article VIII. Chapters and Working Groups"
            >
              <Stack gap="8">
                <Box>
                  <Heading
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    specifically defined topic area regardless of geographical
                    or institutional confines. The Board of Directors may choose
                    to recognize any Chapter or Working Group made up of three
                    or more Members with a duly-elected Chair who may optionally
                    participate in Board of Director meetings in an ex-officio
                    capacity. Chapters or Working Groups who wish to be
                    recognized must apply for recognition and indicate their
                    planned meeting schedule, any proposed Chapter or Working
                    Group structures, and their purpose for organizing. Chapters
                    or Working Groups remain at all times under the supervision
                    and authority of the Board of Directors, which may revoke
                    recognition.
                  </Text>
                </Box>
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    Chapter or Working Group in good standing.
                  </Text>
                </Box>
                <Box>
                  <Heading
            ...
            {/* Article IX */}
            <ArticleSection
              id="Article_IX_Indemnification"
              title="Article IX. Indemnification of Directors, Officers, Employees and Agents"
            >
              <Stack gap="8">
                <Box>
                  <Heading
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    the fact that they are or were a Director, officer, employee
                    or agent of the Society or are or were serving at the
                    request of the Society as a director, trustee, officer,
                    employee or agent of another corporation, partnership, joint
                    venture or other enterprise against expenses (including
                    ...
                    or not opposed to the best interest of the Society and, with
                ...
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    the Society to procure a judgment in its favor by reason of
                    the fact that such person is or was a Director, officer,
                    employee or agent of the Society or is or was serving at the
                    request of the Society as a director, trustee, officer,
                    employee or agent of another corporation, partnership, joint
                    venture, trust or other enterprise against expenses
                    (including attorney&apos;s fees) actually and reasonably
                    incurred in connection with the defense or settlement of
                    such action or suit if such person acted in good faith and
                ...
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    ultimately be determined that they are not entitled to be
                    indemnified by the Society.
                  </Text>
                </Box>
                <Box>
                  <Heading
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    agent of the Society, or is or was serving at the request of
                    the Society as a director, trustee, officer, employee or
                    agent of another corporation, partnership, joint venture,
                    trust or other enterprise against any liability asserted
                    against such person and incurred in any such capacity.
                  </Text>
                </Box>
                <Box>
                  <Heading
            ...
            {/* Article X */}
            <ArticleSection
              id="Article_X_Conflicts_of_Interest"
              title="Article X. Conflicts of Interest"
            >
              <Stack gap="8">
                <Box>
                  <Heading
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    investment or family: (i) an ownership or investment
                    interest in any entity with which the Society has a
                    transaction or arrangement; (ii) a compensation arrangement
                    with the Society or with any entity or individual with which
                    the Society has a transaction or arrangement; or (iii) a
                    potential ownership or investment interest in, or
                    compensation arrangement with, any entity or individual with
                    which the Society is negotiating a transaction or
                    arrangement.
                  </Text>
                </Box>
                <Box>
                ...
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    committee shall inform the Interested Person of the basis
                    for such belief and afford the Interested Person an
                ...
                <Box>
                  ...
                  <Text color={{ base: "slate.700", _dark: "gray.300" }} lineHeight="tall">
                    ...
                    of interest, the nature of the financial interest, any
                    action taken to determine whether a conflict of interest was
                    present, and the decision as to whether a conflict of
            ...
            {/* Article XI */}
            <ArticleSection
              id="Article_XI_Fiscal_Year"
              title="Article XI. Fiscal Year"
            >
              <Stack gap="8">
                <Box>
                  <Heading
            ...
            {/* Article XII */}
            <ArticleSection
              id="Article_XII_Policy_Against_Discrimination"
              title="Article XII. Policy against Discrimination"
            >
              <Text color="slate.700" lineHeight="tall">
                The Society shall not exclude from participation, deny benefits
                or services, or discriminate against any individual, on the
                basis of race, color, national origin, religion, sex or physical
                disability or impairment, under any program or activity it
                sponsors or conducts.
              </Text>
            </ArticleSection>

            {/* Article XIII */}
            <ArticleSection
              id="Article_XIII_Amendments"
              title="Article XIII. Amendments"
            >
              <Text color="slate.700" lineHeight="tall">
                Subject to the provisions of the Certificate of Incorporation,
                the Members or the Board of Directors may amend or repeal these
                Bylaws at any meeting or by written consent. The Secretary shall
                record all amendments or repeals of these Bylaws by making the
                required changes on the Society&apos;s copy of the Bylaws and
                either noting the effective time of the change (and all other
                changes following the last restatement of the Bylaws) in a
                parenthetical following the amended or deleted Section or
                restating and certifying an amended and restated version of the
                then effective Bylaws.
              </Text>
            </ArticleSection>

            {/* Article XIV */}
            <ArticleSection
              id="Article_XIV_Dissolution"
              title="Article XIV. Dissolution"
            >
              <Text color="slate.700" lineHeight="tall">
                In the event of the dissolution or termination of the Society,
                title to and possession of all the property of the incorporated
                Society shall pass forthwith to such organization or
                organizations qualified for exemption under Section 501(c)(3) of
                the Internal Revenue Code of 1954, as amended, that in the
                option of the Board of Directors is or are best fitted to carry
                on the purpose of the MidSouth Computational Biology and
  ...
  return (
    <Box as="article" id={id}>
      <Heading
        ...
        fontSize="xl"
        fontWeight="bold"
        color={{ base: "red.800", _dark: "red.400" }}
        mb="6"
        pb="3"
