...
export const metadata: Metadata = {
  title: "Events | MidSouth Computational Biology and Bioinformatics Society",
  description:
          ...
          <Tabs.Content value="career">
            <Stack spacing={8}>
              ...
              <Text>
                ...
                junior faculty. Topics include professional development,
                mentoring from academia and industry leaders, grant and
                manuscript writing, and best practices for building an impactful
                career in biomedical data sciences. Seminars are offered monthly
                as virtual sessions, with in-person offerings during the MCBIOS
                Annual Conference.
              </Text>
